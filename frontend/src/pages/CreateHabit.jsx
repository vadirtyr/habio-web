...
export default function CreateHabit() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      toast.error(
        err.response?.data?.detail || err.message || "Failed to create habit"
      );
    } finally {
      setSaving(false);
    }
      ...
      <div style={styles.card}>
        <div style={styles.header}>
          <div>
            ...
            <p style={styles.subtitle}>Start small. Make it repeatable.</p>
          </div>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <input
            ...
            placeholder="Drink water, walk 10 minutes, read..."
          />
