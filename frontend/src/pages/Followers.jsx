...
export default function Followers() {
  ...
  return (
    <div style={styles.page} data-testid="followers-page">
      <header style={styles.header}>
        <p style={styles.eyebrow}>Community</p>
        <h1 style={styles.title}>Followers</h1>
        <p style={styles.subtitle}>
          {username ? `@${username}` : "People following this orbit"}
        </p>
      </header>

      {loading ? (
        <p style={styles.status}>Loading followers...</p>
      ) : followers.length === 0 ? (
        <div style={styles.empty}>
          <Users size={40} />
          <h2 style={styles.emptyTitle}>No followers yet</h2>
