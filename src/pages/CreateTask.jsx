  ...
  async function handleSubmit(e) {
    ...
    try {
      await api.post("/tasks", {
        title: title.trim(),
        name: title.trim(),                 // 👈 some backends expect this
        description: notes.trim(),          // 👈 often required instead of notes
        notes: notes.trim(),
        priority,
        due_date: dueDate || null,
        reward_coins: Number(rewardCoins),
        coins: Number(rewardCoins),         // 👈 backend compatibility
        completed: false,
      });
      ...
      <div style={styles.card}>
        <div style={styles.header}>
          <div>
            ...
            <p style={styles.subtitle}>Add a one-time win to knock out.</p>
          </div>
        ...
        <form onSubmit={handleSubmit} style={styles.form}>
          ...
          <input
            ...
            placeholder="Pay bill, clean garage, finish proposal..."
          />
